        ...
        <div className="grid grid-cols-3 gap-3 select-none">
            {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map(num => (
                <button 
                    ...
                    className={`aspect-square text-3xl font-bold p-4 rounded-xl transition-all duration-75 focus:outline-none focus-visible:ring-4 focus-visible:ring-brand-secondary dark:bg-dark-subtle dark:text-dark-text dark:focus-visible:ring-dark-secondary ${
                        isHighlighted(num)
            ...
            <button 
                ...
                className={`aspect-square col-start-2 text-3xl font-bold p-4 rounded-xl transition-all duration-75 focus:outline-none focus-visible:ring-4 focus-visible:ring-brand-secondary dark:bg-dark-subtle dark:text-dark-text dark:focus-visible:ring-dark-secondary ${
                    isHighlighted('0')
                    ? 'bg-brand-secondary/70 dark:bg-dark-secondary/70 scale-90 shadow-inner' 
                    : 'bg-gray-200 shadow-md'
                }`}
            ...
            {onDeleteClick && (
                <button 
                    ...
                    className={`aspect-square p-4 rounded-xl transition-all duration-75 flex items-center justify-center focus:outline-none focus-visible:ring-4 focus-visible:ring-red-400 dark:focus-visible:ring-red-500 ${
